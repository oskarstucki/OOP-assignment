...
public class interfaceController {
    ...
    /**
     * This initializes the gui window. Following things are loaded:
     * -Smartpost locations
     * -Default items
     * -Sendbutton is initialized
     * -previousdata is loaded and storage list is filled
     *
     */
    ...
    /**
     * Listview is initialized and the session start is logged to the log
     */
    ...
    /**
     * Last saved storage stage is loaded if it exists or if it the users wants to load it
     *
     */
    ...
    /**
     * Takes in
     * @param list of smartpost objects and saves it to private array which is used for combobox
     *
     */
    ...
    /**
     *
     * Adds a smartpostlocation to the map
     */
    ...
    /**
     * adds new items to the combobox where it can be sent forward
     *
     */
    @FXML public void AddNewItem(ActionEvent event ){
        if(!isDouble(newThingHeight.getText())){
            ...
            alert.showAndWait();
            newThingHeight.setText("");
            newThingWidth.setText("");
            newThingWeight.setText("");
            newThingName.setText("");
            newThingLength.setText("");
     ...
     * and returns
     * @return boolean
     * true if string can be converted to double
     * false if not
     */
     ...
     * Takes in string
     * @param allerter
     * which it uses to allert user from something
     */
    ...
    /**
     * Draws path between sender and receiver
     */
